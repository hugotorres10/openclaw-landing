...
const INITIAL: Integration[] = [
  ...
  },
  {
    ...
    sidebarIcon: <div className="flex gap-1"><InstagramIcon size={14} /><XTwitterIcon size={12} /><FacebookIcon size={14} /></div>,
  ...
  },
  {
    ...
    sidebarIcon: <div className="flex gap-1"><WhatsAppIcon size={16} /><TelegramIcon size={16} /></div>,
